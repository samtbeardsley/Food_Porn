...
#load model
json_file = open('drive/My Drive/FoodPorn/Models/model.json','r')
model_json = json_file.read()
json_file.close()
model = model_from_json(model_json)
model.load_weights('drive/My Drive/FoodPorn/Models/model.h5')
...
article = 'The Food Pornographer is a convolutional neural network made using transfer learning with the ResNet50 architecture. If you would like to learn more about this project you can visit my github <a href="https://github.com/samtbeardsley/Food_Porn">here</a> or drop me a line at <a href = "mailto: samtbeardsley@gmail.com">samtbeardsley@gmail.com</a>!'
